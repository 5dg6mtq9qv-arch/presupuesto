"""
Django settings for taskbudget project.
...
# Commands, WSGI/ASGI and scheduled jobs now share the same local configuration.
...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    "django-insecure-@=8166u9fy@!@9vq9i2%6mu$wubcfbr-6g5&adl7idx(@yz9nz",
)
...
WSGI_APPLICATION = 'taskbudget.wsgi.application'
